...
public class SelectCourseButtonScript : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        if (other.CompareTag("HandPositionApproximation"))
        {
            ...
            //calling the Select Course and Load VRLE method from the UI Controller
            uiController.SelectCourseAndLoadVRLE();
        }
    }
